            ...
            <table className="min-w-full divide-y divide-gray-700/50">
              ...
              <tbody className="divide-y divide-gray-800/70">
                {downloadJobs.map((job) => (
                  <tr
                    key={job.jobId}
                    className="hover:bg-gray-800/60 transition-colors cursor-default"
                  >
                    <td className="py-3 px-4 font-mono text-sm text-cyan-300/80 max-w-xs truncate">
                      {job.jobId}
                    </td>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-400">
                View distributed request traces and performance bottlenecks.
              </p>
            </div>
            <svg
              className="w-8 h-8 text-orange-400 group-hover:translate-x-1 transition-transform"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-400">
                Manage and resolve application errors and exceptions.
              </p>
            </div>
            <svg
              className="w-8 h-8 text-purple-400 group-hover:translate-x-1 transition-transform"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
        ...
        >
          ...
          >
            <h3 className="text-3xl font-extrabold text-white border-b border-gray-700/70 pb-3 mb-4">
              Job Details:{" "}
              <span className="font-mono text-cyan-400 text-xl block sm:inline">
                {selectedJob.jobId}
              </span>
            </h3>
            <div className="mb-4">
