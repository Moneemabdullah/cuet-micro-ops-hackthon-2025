...
<<<<<<< HEAD
  ...
  const statusText =
    healthData?.status ||
    (loading ? "Loading..." : error ? "Critical Error" : "Unknown");
  ...
  return (
    ...
    >
      ...
      <div
        className={`flex items-center justify-between px-4 py-3 rounded-lg shadow-inner mb-4 ${
          isHealthy
      ...
      <p className="text-xs text-gray-500 mt-4 text-right">
        Last Sync: {lastRefresh.toLocaleTimeString()} | Next in:{" "}
