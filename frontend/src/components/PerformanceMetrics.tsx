...
export const PerformanceMetrics: React.FC = () => {
  ...
  return (
    ...
    <div 
      className="bg-black/30 backdrop-blur-lg rounded-xl p-6 shadow-2xl border border-gray-700/50 hover:shadow-purple-500/20 transition-all duration-300"
    >
      <div className="flex items-center justify-between gap-3 mb-6 border-b border-gray-700/50 pb-3">
        ...
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-2xl font-extrabold text-white">Live Performance Metrics</h2>
        </div>
        ...
        {metricCards.map((metric, index) => (
          ...
          >
            <div className="flex justify-between items-start mb-3">
                ...
                {/* Value (Large) */}
                <p className={`text-4xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r ${metric.color} transition-all duration-300 group-hover:scale-105`}>
                    {metric.value}
                </p>
            </div>

            {/* Label and Description */}
            <p className="text-gray-200 text-lg font-semibold mb-1">{metric.label}</p>
